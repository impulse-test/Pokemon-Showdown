...
exports.commands = {
	...
	gc: 'givecurrency', //You can change "gc" and "giveBucks" to your currency name for an alias that applies to your currency Example: AwesomeBucks could be "ga" and "giveawesomebucks"
	...
	tc: 'takecurrency', //You can change "tc" and "takeBucks" to your currency name for an alias that applies to your currency Example: AwesomeBucks could be "ta" and "takeawesomebucks"
